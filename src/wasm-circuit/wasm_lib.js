...
function __wbg_adapter_28(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2b21a46417bc02e3(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Uint8Array}
*/
export function gen_proof(data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.gen_proof(retptr, addHeapObject(data));
...
* @returns {boolean}
*/
export function verify_proof(data, proof) {
    const ret = wasm.verify_proof(addHeapObject(data), addHeapObject(proof));
    return ret !== 0;
}
...
*/
export function test_SubtleCrypto() {
    const ret = wasm.test_SubtleCrypto();
...
* @returns {string}
*/
export function garble_circuit_to_output(c, g, i) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passStringToWasm0(g, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(i, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.garble_circuit_to_output(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred4_0 = r0;
        deferred4_1 = r1;
...
function __wbg_adapter_89(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h7a9ac650d77a8bb4(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}

const MPCWorkFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mpcwork_free(ptr >>> 0, 1));
/**
*/
export class MPCWork {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MPCWorkFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mpcwork_free(ptr, 0);
    }
    /**
    * @param {string} c
    */
    constructor(c) {
        try {
            ...
            const ptr0 = passStringToWasm0(c, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.mpcwork_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            ...
            this.__wbg_ptr = r0 >>> 0;
            MPCWorkFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    ...
    * @param {any} g
    */
    setup_garble_circuit(g) {
        wasm.mpcwork_setup_garble_circuit(this.__wbg_ptr, addHeapObject(g));
    }
    /**
    * @param {any} egs
    */
    setup_encrypted_gates(egs) {
        wasm.mpcwork_setup_encrypted_gates(this.__wbg_ptr, addHeapObject(egs));
    }
    /**
    * @param {any} i
    */
    setup_input(i) {
        wasm.mpcwork_setup_input(this.__wbg_ptr, addHeapObject(i));
    }
    /**
    * @returns {any}
    */
    evaluate() {
        const ret = wasm.mpcwork_evaluate(this.__wbg_ptr);
        return takeObject(ret);
    }
}
...
export class ZKReceiver {
    ...
    */
    constructor(iknp_count, mpf_height, mpf_round) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.zkreceiver_new(retptr, iknp_count, mpf_height, mpf_round);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    */
    setup_iknp_receiver(data) {
        wasm.zkreceiver_setup_iknp_receiver(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @returns {any}
    */
    ...
    */
    decrypt_iknp_receiver(data) {
        wasm.zkreceiver_decrypt_iknp_receiver(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @param {number} iknp_count
    * @param {number} mpf_height
    ...
    */
    encrypt_silent_receiver_mpf(data) {
        const ret = wasm.zkreceiver_encrypt_silent_receiver_mpf(this.__wbg_ptr, addHeapObject(data));
        return takeObject(ret);
    }
    /**
    * @param {any} data
    ...
    */
    verifier_evaluate(data) {
        const ret = wasm.zkreceiver_verifier_evaluate(this.__wbg_ptr, addHeapObject(data));
        return takeObject(ret);
    }
    /**
    * @param {any} data
    ...
    */
    verifier_waterfall_evaluate(data) {
        const ret = wasm.zkreceiver_verifier_waterfall_evaluate(this.__wbg_ptr, addHeapObject(data));
        return takeObject(ret);
    }
}
...
export class ZKSender {
    ...
    */
    constructor(iknp_count, mpf_height, mpf_round) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.zksender_new(retptr, iknp_count, mpf_height, mpf_round);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    */
    setup_iknp_sender(data) {
        wasm.zksender_setup_iknp_sender(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @returns {any}
    */
    ...
    */
    decrypt_silent_sender_mpf(data) {
        wasm.zksender_decrypt_silent_sender_mpf(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    * @param {any} data
    * @returns {any}
    */
    prover_evaluate(data) {
        const ret = wasm.zksender_prover_evaluate(this.__wbg_ptr, addHeapObject(data));
        return takeObject(ret);
    }
    /**
    * @param {any} data
    ...
    */
    prover_waterfall_evaluate(data) {
        const ret = wasm.zksender_prover_waterfall_evaluate(this.__wbg_ptr, addHeapObject(data));
        return takeObject(ret);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_importKey_8baee829a1496864 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
    ...
    imports.wbg.__wbg_encrypt_664b4c5ec3b3f646 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
